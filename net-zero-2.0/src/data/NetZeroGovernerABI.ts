export const NetZeroGovernerABI = [
	{
		"inputs": [
			{
	...
	{
		"inputs": [],
		"name": "institutionDepositForVotes",
		"outputs": [],
		"stateMutability": "payable",
		"type": "function"
	},
